...
helm install -f "$DIR"/istio/base-1.14.1/base/values.yaml base "$DIR"/istio/base-1.14.1/base/
helm install -f "$DIR"/istio/istiod-1.14.1/istiod/values.yaml istiod "$DIR"/istio/istiod-1.14.1/istiod/ -n istio-system
helm install -f "$DIR"/istio/gateway-1.14.1/gateway/values.yaml ingressgateway "$DIR"/istio/gateway-1.14.1/gateway/ -n istio-system
