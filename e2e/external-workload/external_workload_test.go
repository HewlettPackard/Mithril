...
func TestExternalWorkload(t *testing.T) {
	...
	t.Run("request_external_workload_from_sleep_pod", requestExternalWorkloadFromSleepPod)
}

func requestExternalWorkloadFromSleepPod(t *testing.T) {
	...
	command := "cat -e /tmp/external_workload_test_response.txt"
	cmd := []string{
		"sh",
		"-c",
		command,
