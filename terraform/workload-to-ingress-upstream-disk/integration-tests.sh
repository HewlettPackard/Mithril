...
bash -c "chmod +x /mithril/usecases/workload-to-ingress-upstream-disk/server-cluster/create-kind-cluster.sh && /mithril/usecases/workload-to-ingress-upstream-disk/server-cluster/create-kind-cluster.sh"
