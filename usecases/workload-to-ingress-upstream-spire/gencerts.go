...
func main() {
	...
	writeKey(filepath.Join(dir, "nestedA/agent-nestedA.key.pem"), agentKey)
	writeCerts(filepath.Join(dir, "nestedA/agent-nestedA.crt.pem"), agentCert)
	...
	writeKey(filepath.Join(dir, "nestedB/agent-nestedB.key.pem"), agentKey)
	writeCerts(filepath.Join(dir, "nestedB/agent-nestedB.crt.pem"), agentCert)
}
